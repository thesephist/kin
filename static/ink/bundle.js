...
highlightInkBlock = blockEl => (() => { let prog; prog = (() => {let __ink_acc_trgt = __as_ink_string(blockEl); return __is_ink_string(__ink_acc_trgt) ? __ink_acc_trgt.valueOf()[textContent] || null : (__ink_acc_trgt.textContent !== undefined ? __ink_acc_trgt.textContent : null)})(); return (() => {let __ink_assgn_trgt = __as_ink_string(blockEl); __is_ink_string(__ink_assgn_trgt) ? __ink_assgn_trgt.assign(innerHTML, highlightInkProg(prog)) : (__ink_assgn_trgt.innerHTML) = highlightInkProg(prog); return __ink_assgn_trgt})() })();
